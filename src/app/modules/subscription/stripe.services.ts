...
//             // 2. For free tiers, create a one-time price instead of recurring
//             if (data.cost === 0) {
...
//                 // 3. Create payment link for free tiers as well (for tracking)
...
//                         type: "redirect",
//                         redirect: {
//                             url: `${config.client_url}/subscription/success?tier=${data.level}`,
//                         },
//                     },
//                 });
//             }
//             // 4. Create price for paid subscriptions
...
//                 // 5. Create payment link for paid subscriptions
//                 paymentLink = await stripe.paymentLinks.create({
//                     line_items: [
//                         {
//                             price: price.id,
...
//                 paymentLink: paymentLink?.url || `${config.client_url}/subscribe/free`,
//             };
//         } catch (error) {
