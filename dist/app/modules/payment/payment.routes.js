...
//BOOKING FEE ROUTES
router.post("/create-booking-fee", auth_1.default, payment_controllers_1.paymentControllers.createBookingFeePayment);
router.post("/confirm-booking-fee", auth_1.default, payment_controllers_1.paymentControllers.confirmBookingFeePayment);
...
router.get("/property/:propertyId", auth_1.default, payment_controllers_1.paymentControllers.getPaymentsByProperty);
