...
exports.sendContactReply = void 0;
const nodemailer_1 = __importDefault(require("nodemailer"));
const config_1 = __importDefault(require("../../config"));
const emailTemplates_1 = require("../../../shared/emailTemplates");
const sendContactReply = (_a) => __awaiter(void 0, [_a], void 0, function* ({ to, name, originalMessage, reply }) {
    ...
    const html = (0, emailTemplates_1.contactReplyTemplate)({ name, message: originalMessage, reply });
